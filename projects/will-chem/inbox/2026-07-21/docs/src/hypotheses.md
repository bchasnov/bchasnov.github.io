...
- **Aromaticity (aromaticity):** cyclopropenyl (2π aromatic) vs allyl; tropylium;
...
- **Heteroatom/substituent (aromaticity):** oxocarbenium & anomeric effect; acylium;
...
*For aromaticity / hyperconjugation work: UMA is an excellent fast engine for
